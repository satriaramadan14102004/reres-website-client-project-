...
const basePhotoLibrary = [
  {
    id: '01',
    assetKey: 'memory1',
    title: 'Di rumah sasat',
    description:
      'Diantara berat hirup pikuknya dunia, pelukanmu tetep jadi tempat istirahat ternyaman.',
    tone: 'from-rose-400/45 via-transparent to-transparent',
    meta: ['Bogor Jawa Barat', 'Rumah Sasat'],
  },
  {
    id: '02',
    assetKey: 'memory2',
    title: 'Motoran Di Minggu Pagi',
    description: 'Akan kubawa kamu ke semua hobi ku',
    tone: 'from-sky-400/45 via-transparent to-transparent',
    meta: ['Sentul Nirwarna Residen', 'Vespa Lx 125 i-Get'],
  },
  {
    id: '03',
    assetKey: 'memory3',
    title: 'Lomba Paskibra Di SMA Negeri 4 Bogor',
    description: 'Pohon sma 4 jadi saksi bahwa kita berdua pernah foto bersama disitu haha',
    tone: 'from-amber-200/35 via-transparent to-transparent',
    meta: ['SMA NEGERI 4 KOTA BOGOR', 'PASKIBRA MOMENT'],
  },
  {
    id: '04',
    assetKey: 'memory4',
    title: 'Bunga spesial untuk orang spesial',
    description: 'Dari harumnya mawar dan layu nya bunga. semoga kita bisa terus harum dan tidak akan pernah layu',
    tone: 'from-emerald-300/40 via-transparent to-transparent',
    meta: ['Danau Ciomas Permai', 'Bunga mawar'],
  },
  {
    id: '05',
    assetKey: 'memory5',
    title: 'Mendaki Bareng',
    description: 'Gunung halimun salak, di ketinggian 1658 MDPL. jadi saksi bahwa cinta kita pernah berada diketinggian sana',
    tone: 'from-violet-300/35 via-transparent to-transparent',
    meta: ['Gunung Halimun Salak', 'Pendakian'],
  },
  {
    id: '06',
    assetKey: 'memory6',
    title: 'Ulang Tahun Alika',
    description: '28 Agustus 2025 adalah hari dimana alika genap 18 Tahun',
    tone: 'from-fuchsia-300/35 via-transparent to-transparent',
    meta: ['Selamat Ulang Tahun', 'Rumah Alika'],
  },
  {
    id: '07',
    assetKey: 'memory7',
    title: 'Sirkuit Internasional Sentul',
    description: 'Ini moment dimana kita lagi nonton, pertandingan balap vespa matic di sirkuit sentul. dan tertangkap kamera BTV',
    tone: 'from-fuchsia-300/35 via-transparent to-transparent',
    meta: ['ScooterPrix', 'Sentul International Circuit'],
  },
  {
    id: '08',
    assetKey: 'memory8',
    title: 'Boxies Tajur',
    description: 'Boxies tajur ini tempat langgangan kita kalau nonton bioskop. ini antara kamu dan cimi sama sama dua mahluk yang penting dihidupku wkwkwk',
    tone: 'from-fuchsia-300/35 via-transparent to-transparent',
    meta: ['Boxies Tajur Bogor', 'Vespa Lx 125 i-Get'],
  },
  {
    id: '09',
    assetKey: 'memory9',
    title: 'Selfie Di Boxies Tajur',
    description: 'Hahaha ini selfie moment aja, pas kita nunggu giliran masuk buat nonton bioksop (FILM KANG SOLAH X NENEK GAYUNG)',
    tone: 'from-fuchsia-300/35 via-transparent to-transparent',
    meta: ['Boxies Tajur Bogor', 'iPhone 15 Selfie Camera'],
  },
  {
    id: '10',
    assetKey: 'memory10',
    title: 'Ulang Tahun Sasat',
    description: 'HEHEHE ini ulang tahun sasat yang ke 21. WYATB Thank you Juga alika',
    tone: 'from-fuchsia-300/35 via-transparent to-transparent',
    meta: ['Selamat Ulang Tahun', 'Rumah Sasat'],
  },
];
