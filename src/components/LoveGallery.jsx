...
const basePhotoLibrary = [
  ...
  },
  {
    ...
    assetKey: 'memory3',
    title: '',
    description: 'Setelah masalah dihari kartini, niatnya ini kesempatan terakhir kamu buat ketemu sama aku, tapi aku gabisa par. lebih baik aku kesiksa karena sering ke distract masalah itu daripada aku harus terpaksa jauhin kamu kaya gini',
  ...
  },
  {
    id: '05',
    assetKey: 'memory5',
    title: 'Tengil banget si par',
    description: 'rafa faiz alfaqih, berat banget anj sumpah aku gabisa kaya gini',
